...
const minhook = switch (builtin.cpu.arch) {
    .x86 => struct {
        extern "Minhook.x86" fn MH_Initialize() callconv(.C) MH_STATUS;
        extern "MinHook.x86" fn MH_Uninitialize() callconv(.C) MH_STATUS;
        extern "MinHook.x86" fn MH_ApplyQueued() callconv(.C) MH_STATUS;
        extern "MinHook.x86" fn MH_QueueEnableHook(?*align(1) const anyopaque) callconv(.C) MH_STATUS;
        extern "MinHook.x86" fn MH_QueueDisableHook(?*align(1) const anyopaque) callconv(.C) MH_STATUS;
        extern "Minhook.x86" fn MH_RemoveHook(*align(1) const anyopaque) callconv(.C) MH_STATUS;
        extern "Minhook.x86" fn MH_EnableHook(?*align(1) const anyopaque) callconv(.C) MH_STATUS;
        extern "Minhook.x86" fn MH_DisableHook(?*align(1) const anyopaque) callconv(.C) MH_STATUS;
        extern "MinHook.x86" fn MH_CreateHook(*align(1) const anyopaque, *align(1) const anyopaque, ?*align(1) const anyopaque) callconv(.C) MH_STATUS;
    },
    .x86_64 => struct {
        extern "Minhook.x64" fn MH_Initialize() callconv(.C) MH_STATUS;
        extern "MinHook.x64" fn MH_Uninitialize() callconv(.C) MH_STATUS;
        extern "MinHook.x64" fn MH_ApplyQueued() callconv(.C) MH_STATUS;
        extern "MinHook.x64" fn MH_QueueEnableHook(?*align(1) const anyopaque) callconv(.C) MH_STATUS;
        extern "MinHook.x64" fn MH_QueueDisableHook(?*align(1) const anyopaque) callconv(.C) MH_STATUS;
        extern "Minhook.x64" fn MH_RemoveHook(*align(1) const anyopaque) callconv(.C) MH_STATUS;
        extern "Minhook.x64" fn MH_EnableHook(?*align(1) const anyopaque) callconv(.C) MH_STATUS;
        extern "Minhook.x64" fn MH_DisableHook(?*align(1) const anyopaque) callconv(.C) MH_STATUS;
        extern "MinHook.x64" fn MH_CreateHook(*align(1) const anyopaque, *align(1) const anyopaque, ?*align(1) const anyopaque) callconv(.C) MH_STATUS;
    },
    else => unreachable,
};
